...
class BaseConfig(object):
    ...
    def __init__(self) -> None:
        ...
        self._train_stat_dataloader :DataLoader = None
    ...
    def train_stat_dataloader(self) -> DataLoader:
        return self._train_stat_dataloader

    @train_stat_dataloader.setter
    def train_stat_dataloader(self, loader):
        self._train_stat_dataloader = loader
