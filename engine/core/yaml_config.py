...
class YAMLConfig(BaseConfig):
    ...
    @property
    def train_stat_dataloader(self, ) -> DataLoader:
        if self._train_stat_dataloader is None and 'train_stat_dataloader' in self.yaml_cfg:
            self._train_stat_dataloader = self.build_dataloader('train_stat_dataloader')
        return super().train_stat_dataloader
