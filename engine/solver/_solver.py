...
class BaseSolver(object):
    ...
    def train(self):
        ...
        self.train_stat_dataloader = None
        if getattr(self.cfg, 'train_stat_dataloader', None) is not None:
            self.train_stat_dataloader = dist_utils.warp_loader(
                self.cfg.train_stat_dataloader, shuffle=self.cfg.train_stat_dataloader.shuffle
            )
